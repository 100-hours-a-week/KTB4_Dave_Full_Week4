...
class UserAccountControllerTest {
    ...
    void signUpSuccess() throws Exception {
        ...
        when(accountCommandService.signUp(request)).thenReturn(response);
        ...
        verify(accountCommandService).signUp(request);
    }
    ...
    void signUpReturnsBadRequestWhenEmailFormatIsInvalid() throws Exception {
        ...
        verifyNoInteractions(accountCommandService, availabilityQueryService, authService);
    }
    ...
    void signUpReturnsConflictWhenEmailIsDuplicated() throws Exception {
        ...
        when(accountCommandService.signUp(request))
    ...
    void checkEmailDuplicateReturnsConflictWhenEmailExists() throws Exception {
        ...
        when(availabilityQueryService.isExistEmail(email)).thenReturn(true);
        ...
        verify(availabilityQueryService).isExistEmail(email);
    }
    ...
    void checkEmailDuplicateReturnsOkWhenEmailIsAvailable() throws Exception {
        ...
        when(availabilityQueryService.isExistEmail(email)).thenReturn(false);
    ...
    void checkNicknameDuplicateReturnsConflictWhenNicknameExists() throws Exception {
        ...
        when(availabilityQueryService.isExistNickname(nickname)).thenReturn(true);
        ...
        verify(availabilityQueryService).isExistNickname(nickname);
    }
    ...
    void checkNicknameDuplicateReturnsOkWhenNicknameIsAvailable() throws Exception {
        ...
        when(availabilityQueryService.isExistNickname(nickname)).thenReturn(false);
    ...
    void signOutSuccess() throws Exception {
        ...
        doNothing().when(authService).signOut(refreshToken);
    ...
    void changePasswordSuccess() throws Exception {
        ...
        doNothing().when(accountCommandService)
        ...
        verify(accountCommandService).changePassword(SIGN_USER_INFO, request);
    }
    ...
    void deleteUserReturnsNotFoundWhenUserDoesNotExist() throws Exception {
        when(accountCommandService.deleteUser(SIGN_USER_INFO))
        ...
        verify(accountCommandService).deleteUser(SIGN_USER_INFO);
    }
